       ...
       >
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" v-for="m in datas" :key="m.id">
                <td class="w-32 p-4">
                    <img :src="m.avatar_url" alt="Apple Watch">
                </td>
                ...
                <td class="px-6 py-4">
                    <button @click="deleteUser(m)" class="font-medium text-rose-600 dark:text-sky-500 hover:underline">Delete</button>
                </td>
            </tr>
...
const getUser = async ()=>{
    ...
    .from("profiles")
    .select("id,full_name,avatar_url,email,bio")
    datas.value = data
    loading.value = false
}
