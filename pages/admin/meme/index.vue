<template>
    <div>
        <div class="grid grid-cols-10 w-full h-full">
            ...
            <div class="col-span-8 pt-28  ">
                 <div class="w-full px-10"> 
                  <span class="bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300 my-5">meme: {{ datas.length }}</span>     
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" v-for="m in datas" :key="m.id">
                <td class="w-32 p-4">
                ...
                <td class="px-6 py-4">
                    <button @click="deleteMeme(m)" class="font-medium text-red-600 dark:text-red-500 hover:underline">remove</button>
                </td>
            </tr>
