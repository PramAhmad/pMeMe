              ...
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                  ...
                  <form method="post" @submit.prevent="updateName">
                    ...
                    <button type="submit"
                      class="py-1 px-3 mt-2 bg-sky-600 rounded-md hover:bg-sky-500 text-center text-white">Ubah</button>
                  </form>
                </div>
        ...
        <form method="post" @submit.prevent="changeData">
          <div class="mb-4">
            ...
            <input
              ...
              id="name" type="text" v-model="props" placeholder="Masukkan nama Anda" required>
          </div>
          <div class="mb-4">
            ...
            <textarea
              class="bg-gray-50 px-3 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
              id="bio" placeholder="Tulis bio Anda di sini" required v-model="bios"></textarea>
          </div>
