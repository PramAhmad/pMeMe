    ...
    <div class="p-3 flex justify-center items-center w-full h-screen">
        ...
        <div
            ...
            <div class="flex justify-between my-5">
                <NuxtLink to="/password/forget"
                    class="mx-auto text-sm decoration-transparent text-blue-700 hover:underline dark:text-blue-500 ">Forgot
                    Password?</NuxtLink>
                <NuxtLink to="/register"
                    class="mx-auto text-sm decoration-transparent text-blue-700 hover:underline dark:text-blue-500 ">
...
async function login() {
    const { user, error } = await supabase.auth.signInWithPassword({
        ...
        redirectTo: 'https://p-meme.vercel.app/'
    })
    navigateTo("/")
